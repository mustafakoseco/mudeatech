...
$(document).ready(function () {
  ...
  $("ul.pattern .color4").on("click", function () {
    return (
      $("#option-color").attr("href", "assets/css/color/dark-purple.css"), !1
    );
  });
  ...
  $("ul.pattern .color8").on("click", function () {
    return (
      $("#option-color").attr("href", "assets/css/color/light-orange.css"), !1
    );
  });
  ...
  $("ul.pattern .color14").on("click", function () {
    return (
      $("#option-color-two").attr("href", "assets/css/color/sky-blue.css"), !1
    );
  });
  $("ul.pattern .color15").on("click", function () {
    return (
      $("#option-color-two").attr("href", "assets/css/color/golden.css"), !1
    );
  });
